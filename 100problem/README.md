...
AtCoder で水色コーダー、つまりレーティング 1200 を少ない問題数で達成するために、茶色コーダー・緑コーダーにとって適切な教育的良問を 100 問解く。
...
4 　パ研杯 2019 C - カラオケ　これが解ければ全探索に慣れたと思って良いです。
...
35 　 DPL_1_B - 0,1 ナップザック問題　基本問題です。
...
65 　 JOI 2010 春合宿 - Finals 　(問題 pdf) JOI 春合宿の問題ですが、比較的簡単です。
